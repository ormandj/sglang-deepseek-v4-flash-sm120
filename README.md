...
- **Long-conversation reuse.** Optional hierarchical KV cache (HiCache) keeps
  evicted prefixes in host memory or on disk. In the measured three-session
  test, returning-turn prefill fell from 18–20 seconds to about 0.5 seconds.
...
|---:|---:|---:|---:|---:|
| 1 | 64.372 | 66.575 | 355.9 | 255.2 |
| 2 | 49.527 | 46.337 | 459.5 | 421.0 |
| 4 | 33.253 | 33.074 | 646.5 | 616.0 |
| 8 | 23.443 | 23.454 | 870.3 | 795.8 |
| 16 | 17.863 | 15.865 | 1389.6 | 1097.2 |
| 32 | 13.344 | not reachable in profile | 2049.6 | — |
...
| TP2 profile | SGLang v0.6.0-rc.3 | vLLM r33 |
|---|---:|---:|
...
| GSM8K, correct / 1,319 | 1,263 (95.75%) | 1,243 (94.24%) |
...
the v24 cache for later starts of this exact image.
